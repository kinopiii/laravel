...
<body>
    ...
    @if(isset($items))
        @if(!$items->isEmpty())
    　　<table border="3" width="700px" align="center">
            
            <th width="30" bgcolor="B0C4DE" style="border-style:dashed;">ID
                @sortablelink('id', '▼')
            </th>
            <th width="30" bgcolor="B0C4DE" style="border-style:dashed;">商品ID</th>
            <th width="30" bgcolor="B0C4DE" style="border-style:dashed;">評価</th>
            <th width="150" bgcolor="B0C4DE" style="border-style:dashed;">商品コメント</th>
            <th width="80" bgcolor="B0C4DE" style="border-style:dashed;">登録日時
                @sortablelink('created_at', '▼')
            </th>
            <th width="40" bgcolor="B0C4DE" style="border-style:dashed;">編集</th>
            <th width="40" bgcolor="B0C4DE" style="border-style:dashed;">詳細</th>
    </form>
            @foreach($items as $item) 
                <tr>
                    <td bgcolor="white" style="border-style:dashed;">{{$item->id}}</td>
                    <td bgcolor="white" style="border-style:dashed;">{{$item->product_id}}</td>
                    ...
                    <td bgcolor="white" style="border-style:dashed;"><a href="/reviews_detail/{{$item->id}}">詳細</a></td>
                </tr>   
            @endforeach
        </table>
        <br>
